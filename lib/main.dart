...
class _TimerScreenState extends State<TimerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: widget.mode == WearMode.active ? Colors.lightGreen : Colors.grey[850],
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            Center(
              child: Image.asset(
                widget.mode == WearMode.active ? 'assets/3.png' : 'assets/4.png',
                width: 70,
                height: 70,
              ),
            ),
            ...
            const SizedBox(height: 5.0),  // Ajuste del espaciado
            _buildWidgetButton(),
          ],
        ),
      ),
      ...
      return Row(
        ...
        children: <Widget>[
          ElevatedButton(
            ...
            child: Icon(
              _status == "Start" || _status == "Continue" ? Icons.play_arrow : Icons.pause,
              size: 17,
            ),
          ),
          ElevatedButton(
